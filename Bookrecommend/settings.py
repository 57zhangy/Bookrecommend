...
SECRET_KEY = '+bnfi!xfntfx4x9#x&-f5oabz#v+l0a&#dv0$inytxk*8-3$oj'
...
MIDDLEWARE = [
    ...
    'authorize.middleware.login_middleware.AuthMiddleware',
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://192.168.43.50:6379',
        "OPTIONS": {
...
#
# HITS_PATH='D:\PC\PyCharm 2018.3.3\Bookrecommend\recommend'
